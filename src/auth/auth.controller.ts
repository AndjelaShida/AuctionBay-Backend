...
export class AuthController {
    ...
    //auth/validate-user
    @Post('validateUser')
    async validateUser(@Body() validateUserDto: {email: string, password: string}): Promise<User> {
        return this.authService.validateUser(validateUserDto.email, validateUserDto.password);
    }
}