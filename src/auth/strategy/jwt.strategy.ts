...
@Injectable()
export class JwtStrategy extends PassportStrategy(Strategy, 'jwt') { //Pravimo novu Passport strategiju, baziranu na Strategy iz passport-jwt, i zvaćemo je 'jwt'", 'jwt' → identifikator ove strategije koji se koristi unutar AuthGuard('jwt')
